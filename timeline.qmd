...
* If necessary, rerun the models for "Turns and Downturns in Aging Drivers" to account for the changes to the participant demographics data.

* Make any other necessary revisions to "Turns and Downturns in Aging Drivers."
...
* Wait for or act on peer-review results for "Turns and Downturns in Aging Drivers."

* Revise and submit the `DrivePlotR` paper for the TRB program. (This paper will be incorporated into Chapter 1 of my thesis.)

* Make slides for my TRB presentation about `DrivePlotR`.
...
* Incorporate any presentation feedback into `DrivePlotR` and the associated paper.

* Create a full draft of Chapter 1 for my thesis, incorporating the `DrivePlotR` paper.

* Continue to develop my position-determination method for map-matching, which will be in Chapter 3 of my thesis. (The development timeline necessarily has some variability depending on setbacks and successes.)

* Wait for or act on peer-review results for "Turns and Downturns in Aging Drivers."

# February 2026

* Continue to refine my position-determination method for map-matching, which will be in Chapter 3 of my thesis. (The development timeline necessarily has some variability depending on setbacks and successes.)
...
* Based on peer-review results for "Turns and Downturns in Aging Drivers", update the paper and incorporate it into Chapter 2 of my thesis to create a full draft. (The timing of this to-do item is subject to change depending on when the paper is submitted and peer-review results arrive.)

# March 2026

* Test my position-determination method in the selected application to get further results. (The development timeline necessarily has some variability depending on setbacks and successes.)

* Edit and improve drafts of Chapters 0, 1, and 2 of my thesis.
...
* Write a full draft of a paper about my position-determination method, which will be incorporated into Chapter 3 of my thesis. (The development timeline necessarily has some variability depending on setbacks and successes.)
...
* Act on peer-review results?

# June 2026

* Finish writing all thesis chapters.

* Create my slides and develop my presentation for my final oral exam.

* Act on peer-review results?

* Send my thesis to committee? (or in July?)
