...
\hline
Variable       & Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                & Unit/Values                                                                                                                                                         \\ \hline
device         & Device ID of Black Box                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     & Character string                                                                                                                                                    \\ \hline
drive          & Numeric value sequentially ordered across time indicating what drive number the data corresponds to                                                                                                                                                                                                                                                                                                                                                                                                                        & Numeric                                                                                                                                                             \\ \hline
time\_utc      & Date time-stamp in UTC                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     & \begin{tabular}[p]{@{}l@{}}UTC\\ Y-M-D H:M:S\end{tabular}                                                                                                           \\ \hline
gps\_long      & Longitude returned from GPS                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                & Decimal degrees                                                                                                                                                     \\ \hline
gps\_lat       & Latitude returned from GPS                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 & Decimal degrees                                                                                                                                                     \\ \hline
gps\_elevation & Elevation returned from GPS                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                & Meters                                                                                                                                                              \\ \hline
gps\_heading   & The direction over the ground the vehicle is currently moving                                                                                                                                                                                                                                                                                                                                                                                                                                                              & Degrees                                                                                                                                                             \\ \hline
gps\_fix       & Value representing the quality of the connection (or ``fix") between the GPS receiver and the GPS satellite constellation. A fix type of 2 gives good GPS location data, but applications that need more precise location estimates (e.g., applications relying on GPS speed) should use a fix type of 3. Theoretically, a fix type of 1 is the worst quality fix type that gives GPS time information, but data inspection suggests that for this study, the worst fix type giving GPS time information may actually be 2. & \begin{tabular}[p]{@{}l@{}}0 = no fix\\ 1 = time only\\ 2 = 2D fix \\ (latitude and longitude)\\ 3 = 3D fix \\ (latitude, longitude, \\ and elevation)\end{tabular} \\ \hline
gps\_sats      & Number of satellites the GPS unit can ``see"                                                                                                                                                                                                                                                                                                                                                                                                                                                                                & Count                                                                                                                                                               \\ \hline
gps\_pdop      & Dilution of Precision measure for 3D position                                                                                                                                                                                                                                                                                                                                                                                                                                                                              & \begin{tabular}[p]{@{}l@{}}\textless{}1 = Ideal\\ 1-2 = Excellent\\ 2-5 = Good\\ 5-10 = Moderate\\ 10-20 = Fair\\ \textgreater{}20 = Poor\end{tabular}              \\ \hline
gps\_hdop      & Dilution of Precision measure for the horizontal plane                                                                                                                                                                                                                                                                                                                                                                                                                                                                     & See gps\_pdop                                                                                                                                                       \\ \hline
gps\_vdop      & Dilution of Precision measure for the vertical plane                                                                                                                                                                                                                                                                                                                                                                                                                                                                       & See gps\_pdop                                                                                                                                                       \\ \hline
gyro\_x        & Angular rotation rate about the right-to-left axis                                                                                                                                                                                                                                                                                                                                                                                                                                                                         & Degrees/sec                                                                                                                                                         \\ \hline
gyro\_y        & Angular rotation rate about the forward-to-backward axis                                                                                                                                                                                                                                                                                                                                                                                                                                                                   & Degrees/sec                                                                                                                                                         \\ \hline
gyro\_z        & Angular rotation rate about the up-to-down axis                                                                                                                                                                                                                                                                                                                                                                                                                                                                            & Degrees/sec                                                                                                                                                         \\ \hline
gyro\_heading  & Heading calculated from compass and gyro data                                                                                                                                                                                                                                                                                                                                                                                                                                                                              & Degrees                                                                                                                                                             \\ \hline
\end{tabular}
\end{table}
\end{center}
```
