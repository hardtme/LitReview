...
Now consider the average acceleration (rate of change for velocity) of the vehicle between two consecutive observed vehicle positions $\symbfit{r}_t$ and $\symbfit{r}_{t+\Delta t}$. This is given by @eq-avgaccel:
$$
...
$$ {#eq-instaccel}
Hence, we can see that instaneous acceleration is the first derivative of velocity with respect to time and the second derivative of position with respect to time.
