...
Example of the shortcomings of naively orthogonally projecting GPS points (blue) onto the nearest road segment (red) while accounting for heading. Note the temporal jump of the two points near the intersection for which the black lines indicating the match intersect.
:::
