...
* PhD in Statistics (Spring 2023-present)
...
* Even advanced methods can still make errors like those shown in the examples.
...
* @kimEfficientUseDigital2000: Kalman filter.
...
* Ideas for approaches:
  ...
  - Linkage problem [@taylorFastBayesianRecord2024].
  
  - Oblique least squares [@mccartinObliqueLinearLeast2010]
  
  - Revisit Kalman filter.
  
## Create an Open-Source Tool for Visualizing Spatiotemporal Transportation Data

* R package `DrivePlotR`.

* Interactive plot-maps relate location in time and space to other variables.
